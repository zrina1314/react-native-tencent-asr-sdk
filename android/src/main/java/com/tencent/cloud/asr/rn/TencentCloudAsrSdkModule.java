...
public class TencentCloudAsrSdkModule extends TencentCloudAsrSdkSpec {
  public static final String NAME = "TencentCloudAsrSdk";
  ...
  @ReactMethod
  public void setup(int appid,int projectId,String secretId,String secretKey,String saveFilePath,Promise promise){
    this.appid =appid;
  ...
  public void recognizerFile(String filePath,String voiceFormat,String engSerViceType,Promise promise){
    initSentenceSDK();
    asrSentenceManager.recognizerFile(filePath, voiceFormat,engSerViceType, promise);
  }
